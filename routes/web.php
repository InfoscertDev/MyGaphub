...
Route::group(['middleware' => ['auth','verified']], function() {
    ...
    Route::group(['prefix' => 'home'], function () {
        ...
        Route::get('/360/philanthropy', 'Web\SeedController@philanthropy')->name('360.philanthropy.store');
    ...
    Route::group(['middleware' => ['admin']], function() {
     ...
     // Route::resource('blog', 'Admin\BlogPostController');
        ...
        Route::name('notifications.')->group(function () {
            // System Notification
            Route::get('notifications/system/create', 'Admin\AdminNotificationController@createSystemNotification')
                ->name('system.create');

            Route::post('notifications/system/send', 'Admin\AdminNotificationController@sendSystemNotification')
                ->name('system.send');

            // Promotional Notification
            Route::get('notifications/promotional/create', 'Admin\AdminNotificationController@createPromotionalNotification')
                ->name('promotional.create');

            Route::post('notifications/promotional/send', 'Admin\AdminNotificationController@sendPromotionalNotification')
                ->name('promotional.send');

            // Template Management
            Route::resource('notifications', 'Admin\AdminNotificationController')->names([
                'index' => 'index',
                'edit' => 'edit',
                'update' => 'update',
            ...
            // Toggle
            Route::patch('notifications/{notification}/toggle', 'Admin\AdminNotificationController@toggleStatus')
                ->name('toggle');
        });
    });
});
