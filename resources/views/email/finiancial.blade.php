...
<body> 
    ...
    <table> 
        <div class="" style="padding: 10px; ">
            <div class="gap-center" style="font-size: 14px; color: black;"> 
                {{-- <p>From: gaphubteam@mygaphub.com</p> 
                <p>To: {{$data['email']}}</p>  
                <p>Subject: {{$data['subject']}}</p>
                <br> --}}
                <p style="text-align: center; margin: 10px auto;">
                    <img style="margin-left: 15px;" src="http://infoscert.net/releasea/gap/assets/images/logo.png" alt="Logo" height="50" class="logo_main">
                </p>
                <p class="margin-top: 10px"> Hello,</p>
                <p> Thank you for using the GAPhub calculator.  </p>
                <p>  {{ $data['please'] }} </p>
                <p>
                    At GAPhub we have extensive resources to help you on your financial independence journey.
                </p><p>
                    To take advantage of our additional personal finance resources, such as our asset portfolio management platform, 
                    periodic budget management system, asset acquisition opportunities and many more, please click the link below to register.
                </p>
                <p style="text-align: center; margin: 10px auto;">
                    <button style="background: #ED3237; padding: 10px 12px;border-radius: 30px;" > 
                        <a href="http://infoscert.net/releasea/gap/register" style="text-decoration: none; color: white;">REGISTER NOW!</a> 
                    </button>
                </p>
                <p>
                    We look forward to having you as part of the GAP family. 
                </p><p>
                    If you have any further questions or need assistance please contact us at <a href="#">gaphubteam@gaphub.com</a>
                </p><p>  
                    Thank you for using GAPhub Products.
                </p><p>  
                    We wish you the very best on your financial journey, 
                </p> 
                <p>The GAPhub Team</p> <br>

                <p style="width: 80%; text-align: center;">  <br> 
