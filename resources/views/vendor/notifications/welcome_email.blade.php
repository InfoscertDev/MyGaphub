...
<!-- @component('mail::button', ['url' => $download_url, 'color' => $download_color])
   Download App
@endcomponent -->  
<div style="text-align: center; margin: 0 auto; width: 100%;">
    <a href="https://mygaphub.com/detector/" class="button" style="background-color: gray;padding: 8px 20px; color: white;" target="_blank" 
