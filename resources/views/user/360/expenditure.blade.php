...
<div class="row">
    <div class="col-md-5 col-sm-12">
        <div class="">
            <h2 class=" bold">Cost of Living: {{$currency}}{{ number_format(array_sum($expenditure_detail['values']) , 2) }}
        ...
        <div class="bar_chart mt-4">
            ...
            <ul class="list-group list-group-flush cash-tiles">
                @foreach ($expenditure_detail['labels'] as $key => $cost)
                    <li class="list-group-item my-1">
                        <span class="mr-2 bold text-capitalize"> Your {{ $cost }}:</span> <span class="mr-2">{{$currency}}{{ number_format($expenditure_detail['values'][$key], 2) }} </span>
                    </li>
                @endforeach
            </ul>
            <div class="mb-3 mt-2">
