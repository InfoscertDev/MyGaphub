                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="price-wrap d-flex ">
                                    ...
                                    <input type="number" name="current" required min="0" placeholder="" class="input-money bs-none wd-f form-control b-rad-10">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-6 col-sm-12"> 
                                <div class="price-wrap d-flex ">
                                    <label for="" class="price-currency mt-2">{{ $currency }}</label>
                                    <input type="number" min="0" name="assured_income" placeholder="E.g  £1,500.00" class="input-money bs-none wd-f form-control b-rad-10">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="price-wrap d-flex ">
                                    <label for="" class="price-currency mt-2">{{ $currency }}</label>
                                    <input type="number" min="0"  required name="monthly_cont" class="input-money bs-none wd-f form-control b-rad-10">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
