...
<div class="row"> 
    <div class="col-md-5 col-sm-12">
        ...
        <div class="bar_chart mt-4">
            <h5 class="text-underline  bold">Components of your Asset</h5>
            <ul class="list-group list-group-flush cash-tiles">
                    ...
                    <a href="{{ route('360.equity')}}" class="card-link d-block">
                        <li class="list-group-item my-1"  >
                            ...
                            <span class="mr-2"> Home Equity -</span> <span class="mr-2 bold">360<sup>o</sup>:</span> <span class="mr-2">{{$currency}}{{ number_format($asset_detail['values'][2], 2)  }}</span> 
                            <span class="pull-right"><i class="fa fa-chevron-right"></i> </span>
                        </li> 
                    </a>
                    </div>
