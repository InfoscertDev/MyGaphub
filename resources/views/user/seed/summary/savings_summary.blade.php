                    ...
                    <div class="list-group">
                        @foreach($savings_allocation as $allocation)
                            <div class="list-group-item">
                                ...
                                <div class="small mb-1 ff-rob" style="margin-left: 36px;">{{$currency}}{{ number_format($allocation->amount, 2) }} Balance</div>
                            </div>
                        @endforeach
                    </div>
                    <p class="my-3 ff-rob text-center" data-toggle="modal" data-target="#savingsAllocationModal" onclick="$('#savingsSummaryModal').modal('hide')">Add more</p>
                </div>
