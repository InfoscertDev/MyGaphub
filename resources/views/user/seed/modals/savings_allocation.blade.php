...
<div class="modal fade" id="savingsAllocationModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
                ...
                <form action="{{ route('seed.store.allocation') }}" method="POST">
                    ...
                    <div class="my-4">
                        ...
                        <div class="form-group my-3 row">
                            ...
                            <div class="col-sm-6">
                                <select name="label" class="form-control" onchange="handleChangeSavingsCategory(this)" id="savings_category" required>
        ...
        <script>
            ...
            // category.addEventListener('input', handleChangeSavingsCategory);

            function handleChangeSavingsCategory(e){
                if(e.value == "Others"){
