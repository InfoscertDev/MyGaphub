...
@section('content')
    @if(request()->input('assigned'))
        <script>
            $(function() {  $('#incomeAllocationModal').modal('show'); })
        </script>
    @endif
    <div class="row">
        <div class="col-sm-12">
        ...
        <div class="col-md-5 col-sm-12 sm-default">
            ...
            <p>
                ...
                @endif
                <span class="text-underline" onclick="$('#incomeAllocationModal').modal('show')"  style="cursor: pointer">Assign Income channels</span>
            </p>
