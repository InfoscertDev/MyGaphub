                        ...
                        <div class="">
                            <form action="#" id="ganpInvest" method="POST">
                                ...
                                <div class="card-img px-5 wd-8 mx-auto text-center sm-wdf sm-no-pad">
                                    <img src="{{ url('https://gapassethub.com/public/'. str_replace('public', 'storage', $plant->image3 )) }}" alt=" " style="height: 300px" class="wd-f py-3 px-2 mb-3">
                ...
                <div class="reap-asset elevation-3">
                    <div class="row">
                        <div class="col-md-4 col-xs-12">
                            <div class="card-img">
                                <img src="{{ url('https://gapassethub.com/public/'. str_replace('public', 'storage', $plant->image2 )) }}" alt=" " style="height: 300px" class="wd-f py-3 px-2">
                            </div>
                        </div>
