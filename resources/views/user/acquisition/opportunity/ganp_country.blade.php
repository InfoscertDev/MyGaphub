    ...
    <div class="wd-f bg-white py-0">
        ...
        {{-- <div class="bg-gap-light b-rad-20">
            <div class="row my-4 wd-8 mx-auto">
                <div class="my-4 b-rad-20 mt-1 cal-head hd-country" style="background: url({{  url('http://prismcheck.com/releasea/ganp/public/'. str_replace('public', 'storage', $gcountry->image)) }}) no-repeat;  background-position: center;" id="authhead">
                            ...
                            <div class="reap-asset mx-2 elevation-3"> 
                                <div class="list-img">
                                    <a href="{{ route('user.single_ganp',[$plant->id, 'tresh' => rand(1000,9999) ]) }}" class="card-link text-white">
                                        <img src="{{ url('http://prismcheck.com/releasea/ganp/public/'. str_replace('public', 'storage', $plant->image1)) }}" alt=" " class="img img-responsive">
                                    </a>
                                </div>
                                <div class="list-body">
                                <div class="px-3 wd-f">
