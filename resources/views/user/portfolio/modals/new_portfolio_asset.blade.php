                    ...
                    <div class="row mx-1"> 
                         ...
                         <div class="col-md-4 col-sm-6 col-xs-4 px-1">
                             <div class="mb-4 plan-box elevation-2 bg-gray-4 pb-3">
                                 ...
                                 <textarea name="description" required placeholder="Answer" id="" class="form-control b-rad-10 gap-center-bl px-2" cols="30" rows="4"></textarea>
                             </div> 
                         </div>
                         <div class="col-md-4 col-sm-6 col-xs-4 px-1"> 
                             <div class="mb-4 plan-box elevation-2 bg-gray-4 pb-3">
                                 <label for="" class="label">What is your asset worth today?                             </label>
                                 <input name="asset_value" required type="number" placeholder="Answer" id="" step="any" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="12"  class="form-control b-rad-10 gap-center-bl px-2">
                             </div>  
                         </div> 
                         <div class="col-md-4 col-sm-6 col-xs-4 px-1">
                             <div class="mb-4 plan-box elevation-2 bg-gray-4 pb-3">
                                 ...
                                 <input name="monthly_roi" required type="number" placeholder="Answer" id="" step="any" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="12"  class="form-control b-rad-10 gap-center-bl px-2">
                             </div> 
                         </div>
                         <div class="col-md-4 col-sm-6 col-xs-4 px-1">
                             <div class="mb-4 plan-box elevation-2 bg-gray-4 pb-3">
                                 ...
                                 <input name="credit_value" required type="number" placeholder="Answer" id="" step="any" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="12"  class="form-control b-rad-10 gap-center-bl px-2">
                             </div> 
                         </div> 
                         <div class="col-md-4 col-sm-6 col-xs-4 px-1">
                             <div class="mb-4 plan-box elevation-2 bg-gray-4 pb-3">
                                 ...
                                 {{-- <textarea name="" required  placeholder="Answer" id="" class="form-control b-rad-10 gap-center-bl px-2" cols="30" rows="4"></textarea> --}}
                                 <input name="projected_value" required type="number" placeholder="Answer" id="" step="any" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="12"  class="form-control b-rad-10 gap-center-bl px-2">
                             </div> 
                         </div>
                    </div>
