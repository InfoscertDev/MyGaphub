                    ...
                    <div class="col-xs-12 col-md-6 mb-2">
                        <div class="text-center mx-auto">
                            ...
                            <div class="text-left mt-1 sm-center"> 
                                ...
                                @else
                                    <p class="">
                                        <h6 class="mt-2 mb-1 wd-8 ln-h1 sm-center" >Your current rainy day savings can last you up to {{ $currenttime }} days. Wow! This is beyond the typical 360-day target.
