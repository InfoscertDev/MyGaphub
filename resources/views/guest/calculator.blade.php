                              ...
                              <ul class="lists">
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      ...
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->periodic_savings }}" min="0" class="" name="periodic_savings" id="periodic_savings" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->education }}" min="0" class="" name="education" id="education" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->mortgage }}" min="0" class="" name="mortgage" id="mortgage" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->mobility }}" min="0" class="" name="mobility" id="mobility" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->expenses }}" min="0" class="" name="expenses" id="expenses" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->utility }}" min="0" class="" name="utility" id="utility" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->dept_repay }}" min="0" class="" name="dept_pay" id="dept_pay" required>
                                ...
                                <li class="row mx-0 bg-white">
                                  ...
                                  <div class="col-md-4">
                                    <div class="price-wrap">
                                      <label for="" class="price-currency"></label>
                                      <input type="number" step="any"  onblur="calcTotalExpenses()" oninput="calcTotalExpenses()" onfocus="focalPoint(this)" value="{{ $calculator->charity }}" min="0" class="" name="charity" id="charity" required>
                            ...
                            <ul class="lists">
                              <li class="row mx-0 bg-white">
                                ...
                                <div class="col-md-4">
                                  <div class="price-wrap">
                                    <label for="" class="price-currency"></label>
                                    <input type="number" step="any" value="{{ $calculator->other_income }}" onfocus="focalPoint(this)"  min="0" class="" name="income" id="income" required>
                                  </div> 
                                </div>  
                              </li>
                              <li class="row mx-0 bg-white">
                                ...
                                <div class="col-md-4">
                                  <div class="price-wrap">
                                    <label for="" class="price-currency"></label>
                                    <input type="number" step="any" value="{{ $calculator->extra_save }}" onfocus="focalPoint(this)"  min="0" class="" name="extra" id="extra" required>
                                  </div> 
                                </div>
                              </li> 
                              <li class="see-result mt-3">
