          ...
          <div class="gap-center">
             <div class="row">
               <div class="col-lg-12 col-sm-12">
                <h4 class="bold text-center my-4 h3"> Customize Gaphub support services </h4>

                <div class="row ">
                    <div class="col-12 my-2">
                        <a  href="{{  route('gap.support.guide') }}"
                            class="support-tile d-flex py-2 shadow-sm card-link" style="cursor: pointer; color: inherit">
