        ...
        <div class="container-fluid">
          <div class="">  
            <ul class="nav nav-tabs full-tab">
              ...
              <li class="nav-item">
                  <a class="nav-link active" href="{{ route('gap.emails.recommendation') }}">Financial Indpendence & Recommendatation</a>
                </li>
              <li class="nav-item">
          ...
          <div class="card my-3">
              ...
              <div class="card-body"> 
                <form action="{{ route('store.emails') }}" method="POST">
                  @csrf
                  <input type="hidden" name="section" value="jhsbjsmbzjhbdnxjhmzbhjmbxjbxhibszjxm93jwihknsjhdsddx">
