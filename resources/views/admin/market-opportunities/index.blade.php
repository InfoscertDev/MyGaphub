...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('market-opportunities.create') }}" class="btn btn-primary">
                Add New Banner
            </a>
        </div>
                ...
                <tbody id="banners-table-body">
                    @foreach($marketOpportunities as $opportunity)
                        <tr data-id="{{ $opportunity->id }}">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.market-opportunities.edit', $opportunity) }}"
                                    class="btn btn-sm btn-outline-primary">
                                        Edit
                                    </a>

                                    <form action="{{ route('admin.market-opportunities.toggle-publish', $opportunity) }}"
                                    ...
                                    <form action="{{ route('admin.market-opportunities.destroy', $opportunity) }}"
