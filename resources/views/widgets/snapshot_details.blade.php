        ...
        <div class="modal-content b-rad-20 wd-c"> 
            <div class="modal-body">
                ...
                <table  class="table table-border gap-table">
                    <tr>
                        <td class="text-left td_para">
                            <span  style="margin-right: 10px;"> <img src="http://infoscert.net/releasea/gap/assets/icon/pdf_current.png" alt="" height="25">
                                Current</span>
                        </td>
                        <td>
                    ...
                    <tr> 
                        <td class="text-left td_para">
                            <span  style="margin-right: 10px;">  <img src="http://infoscert.net/releasea/gap/assets/icon/pdf_target.png" alt="" height="20">
                                Target</span>
                        </td>
                        <td class="text-left td_para">
