            ...
            <tr>     
                ...
                <td> 
                    <div class="price-wrap d-flex ">
                        ...
                        <input type="number" min="0" value="{{$asset->asset_value}}" name="asset_value" id="asset_value"  class="input-money bs-none bg-light wd-7 sm-wdf form-control b-rad-10 mx-0">
                    </div>
                </td>  
            </tr>
            <!-- <tr>     
                ...
                <td> 
                    <div class="price-wrap d-flex">
                        <label for="" class="price-currency mt-2">{{ $asset_currency }}</label>
                        <input type="number" min="0" value="{{$asset->monthly_roi}}" name="income" id="income"  class="input-money bs-none bg-light wd-7 sm-wdf form-control b-rad-10 mx-0">
                    </div>    
                </td> 
            </tr> -->
            <tr>     
