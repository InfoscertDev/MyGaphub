                    ...
                    @if ($dashboard->average_seed)
                        <div class="dash-pane hand mb-p {{sortDashboard('average_seed', $available)}}"  id="seed_pane">
                            ...
                            <div class="row">
                                <div class="col">
                                    <span class="pane-para">
                                        <b class="mr-1"> Savings</b>  <span class="">{{$currency}}{{number_format($average_detail['table']['savings'], 2)}}</span>
                                    </span>
                                    <span class="pane-para">
                                        <b class="mr-1">Expenditure:</b>  <span class="">{{$currency}}{{number_format($average_detail['table']['expenditure'], 2)}}</span>
                                    </span>
                                </div>
                                <div class="col">
                                    <span class="pane-para">
                                        <b class="mr-1"> Education</b>  <span class="">{{$currency}}{{number_format($average_detail['table']['education'], 2)}}</span>
                                    </span>
                                    <span class="pane-para">
                                        <b class="mr-1">Discretionary:</b>  <span class="">{{$currency}}{{number_format($average_detail['table']['discretionary'], 2)}}</span>
                                    </span>
                                </div>
                            </div>
                        </div> 
