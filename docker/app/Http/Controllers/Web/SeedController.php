...
class SeedController extends Controller
{
    ...
    public function create(){
      ...
      $current_detail['table']['savings'] =         array_sum(array_column($savings_allocation->toArray(),'amount'));
      $current_detail['table']['education'] =         array_sum(array_column($education_allocation->toArray(),'amount'));
      return view('user.seed.create', compact('page_title', 'support','seed_backgrounds', 'currency','isValid','current_seed', 'target_seed',
           'current_detail', 'savings_allocation', 'education_allocation'
      ));
    }
