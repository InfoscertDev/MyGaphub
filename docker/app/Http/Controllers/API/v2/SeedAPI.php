...
{ 
    ...
    public function index(Request $request){
      ...
      $education_allocation = SeedBudgetAllocation::where('seed_category', 'education')
                            ->where('user_id', $user->id)->where('period', $month)->get();
      $current_detail['seed']['savings'] =         array_sum(array_column($savings_allocation->toArray(),'amount'));
      $current_detail['seed']['education'] =         array_sum(array_column($education_allocation->toArray(),'amount'));
